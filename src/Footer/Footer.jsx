    ...
    <div className="lg:ml-40 mt-20">
      <footer className="footer p-10 ">
        <nav>
          ...
          <a className="link link-hover text-white text-xl">Sports</a>
        </nav>
        <nav>
          <header className="footer-title text-white text-3xl">ABOUt</header>
        ...
        <nav>
          <header className="footer-title text-white text-3xl">Social</header>
          <div className="grid grid-flow-col gap-4">
            <a>
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                className="fill-current text-blue-500 text-5xl"
              >
